...
function LogoutBtn() {
  ...
  return (
    <button
      className="inline-block sm:px-6 sm:py-2 px-4 py-2 duration-200 hover:bg-gray-600 hover:text-white hover:shadow-md text-red-600 font-semibold text-md rounded-full transition-all ease-in-out"
