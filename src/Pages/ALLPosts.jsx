    ...
    return (
      <div className="flex flex-wrap">
        <div className="w-full py-8">
          <Container>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-items-center items-center gap-4 gap-y-8">
              {posts.map((post) => (
                <PostCard {...post} />
              ))}
            </div>
        ...
        <Container>
          <div className="flex flex-wrap justify-center items-center h-screen">
            <div className="font-open-sans p-2 w-full">
              ...
              <h2 className="text-lg text-center text-black mb-8 transition-colors duration-300">
                Want to Write Some?
                <Link to="/add-post">
                  <span className="ml-2 underline cursor-pointer text-blue-600 font-semibold">
                    Add Post
                  </span>
                </Link>
              </h2>
